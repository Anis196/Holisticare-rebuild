...
import { Brain, Code, Heart, Lightbulb, MessageSquare } from 'lucide-react';
...
import WellnessFormPage from './pages/WellnessFormPage';
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="relative z-10 py-28 px-6 text-center bg-gradient-to-r from-gray-900/90 via-gray-800/90 to-black/90">
        ...
        <p className="text-xl md:text-2xl mb-16 max-w-4xl mx-auto text-gray-300">
          Our team is passionate about using AI to introduce a healthier lifestyle. Meet the minds behind Holisticare.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-16">
          ...
          <div className="bg-gray-800 rounded-lg p-8 shadow-lg text-center transform transition-all duration-300 hover:scale-105 w-full sm:w-80 md:w-96">
            <img src="/assests/harshal.jpg" alt="Team Member 1" className="w-40 h-40 mx-auto rounded-full mb-6" />
          ...
          {/* Team Member 2 */}
          <div className="bg-gray-800 rounded-lg p-8 shadow-lg text-center transform transition-all duration-300 hover:scale-105 w-full sm:w-80 md:w-96">
            <img src="/assets/anis.jpg" alt="Team Member 2" className="w-40 h-40 mx-auto rounded-full mb-6" />
            <h3 className="text-2xl font-semibold text-white">Anis Shaikh</h3>
            <p className="text-gray-400 text-lg">Backend Developer + AI Developer</p>
            <div className="flex justify-center gap-6 mt-6">
      ...
      <footer className="relative z-10 py-8 px-4 border-t border-gray-800 bg-gray-900/80">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center">
          ...
          <div className="w-full md:w-1/3 text-center md:text-right text-gray-400">
            <p>© 2025 Synaptic-Surge | Anis & Harshal</p>
          </div>
        </div>
      </footer>
    </div>
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/fitness-form" element={<FitnessFormPage />} />
      <Route path="/mental-health-form" element={<MentalHealthFormPage />} />
      <Route path="/wellness-form" element={<WellnessFormPage />} />
    </Routes>
  );
}
