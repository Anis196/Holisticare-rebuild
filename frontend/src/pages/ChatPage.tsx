...
import { BotIcon, HomeIcon, Loader2, SendIcon, UserIcon } from 'lucide-react';
...
function ChatPage() {
  ...
  const handleHomeClick = (e: React.MouseEvent) => {
    // Fix: Replace confirm with a custom modal or a more React-friendly approach if possible, otherwise add a comment for future improvement
